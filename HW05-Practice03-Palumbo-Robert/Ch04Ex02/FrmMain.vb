...
#Region "Event Procedures"
    ...
    'when the user clicks on the 'Offer' button or by using the Alt-B hotkey
    'sequence.
    Private Sub _btnOfferGrpStockFrmMain_Click(sender As Object, e As EventArgs) Handles btnOfferGrpStockFrmMain.Click
