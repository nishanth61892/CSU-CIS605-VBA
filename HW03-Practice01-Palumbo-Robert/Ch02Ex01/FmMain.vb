...
'Program:   Ch02Ex01 (practice program)
'File:      FrmMain.vb
'Author:    Robert Palumbo         
'Description:   This is the main user interface form for the 
'               Ch02Ex01 practice program. It allows the user
'               to input a name a birthday but not much else!
'
'Date:      09/02/2015 
'               - Initial creation
'
...
#Region "Behavioral Methods"
    ...
    Private Sub _initializeToolTips()
        ...
        toolTip.SetToolTip(Me.txtUserName, "Please enter your full name")
        toolTip.SetToolTip(Me.dtpBirthdayDate, "Please select your birhtday")
        toolTip.SetToolTip(Me.btnAccept, "Click on button to Accept input")
        toolTip.SetToolTip(Me.btnClear, "Click on button to Clear input")
        toolTip.SetToolTip(Me.btnExit, "Click on button to Exit the program")
        toolTip.SetToolTip(Me.lblProgramOutput, "Program output displayed here")
...
#Region "Event Procedures"
    ...
    'btnClear_Click() is the event procedure that gets called when the
    'user clicks on the Clear button or by using Alt-C hot key sequence.
    'It is used to reset the input (user name & birthday selector
    Private Sub _btnClear_Click(sender As Object, e As EventArgs) Handles btnClear.Click
        'Clear the user name text box
        txtUserName.Clear()

        'Reset the birthday date/time selector to NOW
        dtpBirthdayDate.Value = Now.Date
