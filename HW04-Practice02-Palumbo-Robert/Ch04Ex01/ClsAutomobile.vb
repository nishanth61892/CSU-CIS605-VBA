...
#Region "Behavioral Methods"
    ...
    Public Sub drive(ByVal pDistance As Integer)
        ...
        If pDistance >= 0 Then
            ...
            'Update the odometer on the main form
            FrmMain.updateOdometer(mOdometer)

            'Update the transaction log
            Dim _trx As String =
            "Drive Simulation: Mode=By Distance,  " &
            "Distance=" &
            pDistance.ToString & " " &
            "Odometer=" &
            mOdometer.ToString

            'Updata the transaction log
            FrmMain.updateTrxLog(_trx)
    ...
    Public Sub drive(ByVal pSpeed As Integer, pTime As Decimal)
        ...
        If pSpeed >= 0 And pTime >= 0 Then

            _distance = distance(pSpeed, pTime)
            mOdometer += _distance
            ...
            'Update the transaction log
            Dim _trx As String =
            "Drive Simulation: Mode=Speed&Time, " &
            "Speed=" &
            pSpeed.ToString & " " &
            "Time=" &
            pTime.ToString & " " &
    ...
    Public Shared Function distance(ByVal pSpeed As Integer, pTime As Decimal) As Integer
        ...
        Return Convert.ToInt32(_distance)
